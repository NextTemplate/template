...
import styles from "../../styles/PrivacyPolicy/PrivacyPolicy.module.scss";
      ...
      <div className={styles.privacyPolicy}>
        <div className={styles.area}>
          ...
          <p className={styles.privacyPolicyMainSubTitle}>
            it&apos;me(以下、「当サイト」といいます。)は、当サイト上で提供するサービス(以下、「本サービス」といいます。)における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー(以下、「本ポリシー」といいます。)を定めます。
          </p>
          <>
          ...
          <>
            <h2 className={styles.privacyPolicyTitle}>第4条(利用目的の変更)</h2>
            <div className={styles.privacyPolicyDescription}>
              <ul>
                <li>
            ...
            <div className={styles.privacyPolicyDescription}>
              <ol>
                ...
                <ul>
                  ...
                  <li>
                    1-4.予め次の事項を告知あるいは公表し、かつ当サイトが個人情報保護委員会に届出をしたとき
                  </li>
                  <ul>
                    <li>1-4-1.利用目的に第三者への提供を含むこと</li>
                    <li>1-4-2.第三者に提供されるデータの項目</li>
                    <li>1-4-3.第三者への提供の手段または方法</li>
                    <li>
                      1-4-4.本人の求めに応じて個人情報の第三者への提供を停止すること
                    </li>
                    <li>1-4-5.本人の求めを受け付ける方法</li>
                  </ul>
                </ul>
                <li>
                ...
                <ul>
                  <li>
                    2-1.当サイトが利用目的の達成に必要な範囲内において個人情報の取扱いの全部または一部を委託する場合
                  </li>
                  <li>
          ...
          <>
            <h2 className={styles.privacyPolicyTitle}>第6条(個人情報の開示)</h2>
            <div className={styles.privacyPolicyDescription}>
              <ul>
                <li>1.当サイトサービスの提供・運営のため</li>
                <ul>
                  ...
                  <li>
                    1-2.当サイトの業務の適正な実施に著しい支障を及ぼすおそれがある場合
                  </li>
                  <li>1-3.その他法令に違反することとなる場合</li>
                </ul>
              </ul>
            </div>
          </>
          ...
          <>
            ...
            <div className={styles.privacyPolicyDescription}>
              <ul>
                <li>
                  1.当は、本人から、個人情報が、利用目的の範囲を超えて取り扱われているという理由、または不正の手段により取得されたものであるという理由により、その利用の停止または消去(以下、「利用停止等」といいます。)を求められた場合には、遅滞なく必要な調査を行います。
                </li>
                <li>
          ...
          <>
            ...
            <div className={styles.privacyPolicyDescription}>
              ...
              <br />
              <ul>
                <li>住所:&nbsp;〒000-0000 東京都</li>
                <li>社名:&nbsp;株式会社サンプル</li>
                <li>担当部署:&nbsp;sample</li>
                <li>E-mail:&nbsp;example@mail.com</li>
              </ul>
            </div>
          </>
        </div>
